...
2. The Project Maintainers will review the report
...
If a Project Maintainers member is involved in an incident:
...
The Project Maintainers will follow these guidelines in determining consequences:
...
- Appeals are reviewed by a different Project Maintainers member than the original
...
- Open a [Discussion](https://github.com/hyperpolymath/HackenbushGames.jl/discussions) (for general questions)
