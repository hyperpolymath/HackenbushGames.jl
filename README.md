...
[![Completion Status](https://img.shields.io/badge/Completion-100%25-green)](TOPOLOGY.md) [![OpenSSF Best Practices](https://img.shields.io/badge/OpenSSF-Best_Practices-green?logo=opensourcesecurity)](https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/HackenbushGames.jl)
...
A Julia toolkit for experimenting with Hackenbush positions and the
combinatorial game theory ideas from Padraic Bartlett’s "A Short Guide
to Hackenbush" (VIGRE REU 2006). It provides a small API for building
graphs, cutting edges, evaluating basic positions, and exporting
visualizations.

This project emphasizes transparent rules over heavy automation. It
includes simple evaluators for stalks and small green graphs plus
utilities for nimbers and dyadic rationals.
...
- **Red-Blue Hackenbush** uses {L \| R} game values and the Simplicity
  Rule to identify dyadic rationals for stalks.
...
- **Colon and Fusion** rules and the "flower/jungle" ideas are described
  in the guide; in this package they are documented as concepts and can
  be layered into higher-level analysis later.

# Limitations

The `green_grundy` evaluator is exponential in the number of edges and
is intended for small positions and teaching. Larger graphs should use
specialized algorithms or structural simplifications.
