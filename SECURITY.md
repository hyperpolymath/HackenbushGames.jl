...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/HackenbushGames.jl/security/advisories/new)
...
- This repository (`hyperpolymath/HackenbushGames.jl`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/HackenbushGames.jl/security/advisories)
...
When using HackenbushGames.jl, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/HackenbushGames.jl/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/HackenbushGames.jl/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/HackenbushGames.jl/discussions) |
...
*Thank you for helping keep HackenbushGames.jl and its users safe.* 🛡️
