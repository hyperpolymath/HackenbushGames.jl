...
= Hackenbushgames.Jl — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/HackenbushGames.jl
...
* https://github.com/hyperpolymath/HackenbushGames.jl/issues — report bugs
