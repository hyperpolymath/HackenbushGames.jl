{
  description = "HackenbushGames.jl - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 HackenbushGames.jl development environment"
            echo "Language: mixed"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P HackenbushGames.jl.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/HackenbushGames.jl $out/bin/  # Rust
            # cp bin/HackenbushGames.jl $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/HackenbushGames.jl";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-HackenbushGames.jl" {
