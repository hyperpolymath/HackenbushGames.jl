...
# Justfile for HackenbushGames.jl
...
doctor:
    @echo "Running diagnostics for HackenbushGames.jl..."
...
help-me:
    @echo "=== HackenbushGames.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/HackenbushGames.jl/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: HackenbushGames.jl"
