...
HackenbushGames.jl a harassment-free experience for everyone, regardless
...
. The Project Maintainers will review the report
...
The Project Maintainers will follow these guidelines in determining
consequences:
...
* Appeals are reviewed by a different Project Maintainers member than
the original
...
* Open a
https://github.com/hyperpolymath/HackenbushGames.jl/discussions[Discussion]
