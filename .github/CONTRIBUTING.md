...
git clone <https://github.com/hyperpolymath/HackenbushGames.jl.git> cd
HackenbushGames.jl
...
toolbox create HackenbushGames.jl-dev toolbox enter
HackenbushGames.jl-dev \# Install dependencies manually
...
HackenbushGames.jl/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/HackenbushGames.jl/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/HackenbushGames.jl/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/HackenbushGames.jl/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/HackenbushGames.jl/labels/perimeter-3) — Community sandbox scope
