...
[arabic]
. Navigate to
https://github.com/hyperpolymath/HackenbushGames.jl/security/advisories/new[Report
a Vulnerability] If you cannot use GitHub Security Advisories, you may
email us directly:
...
* This repository (`+hyperpolymath/HackenbushGames.jl+`) and all its
code
...
https://github.com/hyperpolymath/HackenbushGames.jl/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/HackenbushGames.jl/discussions[GitHub
Discussions]
...
_Thank you for helping keep HackenbushGames.jl and its users safe._ 🛡️
